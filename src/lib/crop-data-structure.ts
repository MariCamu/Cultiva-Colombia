...
export interface CropTechnicalSheet {
  id?: string; // For client-side use after fetching. Document ID in Firestore is the actual ID.
  nombre: string;
  imagen_url: string;
...
// Example Document: To be stored with ID 'tomate_cherry_id'
export const tomatoCherryData: Omit<CropTechnicalSheet, 'id'> = {
  nombre: 'Tomate Cherry',
  imagen_url: 'https://placehold.co/600x400.png', // Placeholder URL
  tipo_planta: 'Fruto',
  region_recomendada: ['Andina', 'Caribe'],
  clima: 'Templado',
  dificultad: 'Media',
  duracion_cultivo_dias: '90-120',
  espacio_requerido: 'Maceta Grande',
  ...
  ciclo_vida: [
    { etapa: 'Semilla', duracion: '0-7 días', descripcion: 'Germinación inicial' },
    { etapa: 'Plántula', duracion: '7-21 días', descripcion: 'Primeras hojas verdaderas' },
    { etapa: 'Crecimiento', duracion: '21-60 días', descripcion: 'Desarrollo vegetativo' },
    { etapa: 'Floración', duracion: '60-75 días', descripcion: 'Aparición de flores' },
    { etapa: 'Cosecha', duracion: '75-120 días', descripcion: 'Frutos maduros' },
  ],
  datos_tecnicos: {
  ...
  compatibilidades: ['Albahaca', 'Zanahoria'],
  incompatibilidades: ['Brócoli', 'Coliflor'],
  advertencias_comunes: ['Exceso de agua: puede causar hongos', 'Plagas: pulgones, mosca blanca'],
  costos_aproximados: [
  ...
  recomendaciones_finales: 'Cultivar tomate cherry en casa es gratificante. Asegúrate de podar los brotes laterales para una mejor producción.',
  articulos_relacionados_ids: ['articulo_compost_casero', 'articulo_control_plagas_bio'],
  cultivos_relacionados_ids: ['lechuga_romana_id', 'menta_maceta_id'],
};
