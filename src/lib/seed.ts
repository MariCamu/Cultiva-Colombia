...
const fichasTecnicasCultivos: Partial<CropTechnicalSheet>[] = [
  ...
  // PEGA AQUÍ TUS DATOS CONVERTIDOS DE EXCEL A JSON
  {
    ...
    "imagenes": [{
      ...
      "atribucion": {
        "text": "Foto de Daniel E. Cárdenas en Pixabay",
        "link": "https://pixabay.com/es//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=6612016"
      }
    }],
