...
import { MapPin, Home, User, Leaf, Clock, Sun, ChevronLeft, ChevronRight, CheckCircle, RefreshCw, Star, PlusCircle, Carrot, Wheat, BookHeart, Building, Sprout } from 'lucide-react';
...
const sampleCropsData: SampleCrop[] = [
    ...
    { id: 'mango_caribe', name: 'Mango', regionSlugs: ['caribe'], pancoger: true, patrimonial: false, sembrable_en_casa: 'no', educativo: 'no', description: 'Fruta tropical dulce y jugosa, con múltiples variedades en la región.', imageUrl: 'https://firebasestorage.googleapis.com/v0/b/agrinavigate.firebasestorage.app/o/Cultivos%2Fmango.jpg?alt=media&token=2482a09a-213b-486a-9923-80a9c2f24d75', dataAiHint: 'mango fruit', estimatedPrice: 'Precio moderado', duration: 'Larga (6 meses o más)', spaceRequired: 'Maceta grande o jardín (10+ L)', plantType: 'Frutales', difficulty: 3, daysToHarvest: 1460, lifeCycle: [{ name: 'Semilla' }, { name: 'Plántula' }, { name: 'Crecimiento' }, { name: 'Producción' }, { name: 'Cosecha' }] },
    { id: 'oregano', name: 'Orégano', regionSlugs: ['andina', 'caribe', 'pacifica', 'orinoquia', 'amazonia', 'insular'], pancoger: false, patrimonial: true, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Hierba aromática popular, fácil de cultivar en macetas.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'oregano plant', estimatedPrice: 'Precio bajo', duration: 'Corta (1–2 meses)', spaceRequired: 'Maceta pequeña (1–3 L)', plantType: 'Plantas aromáticas', difficulty: 1, daysToHarvest: 60, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Cosecha' }] },
    { id: 'hierbabuena', name: 'Hierbabuena', regionSlugs: ['andina', 'caribe', 'pacifica', 'orinoquia', 'amazonia', 'insular'], pancoger: false, patrimonial: true, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Hierba aromática refrescante y de crecimiento rápido, ideal para principiantes.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'mint plant', estimatedPrice: 'Precio bajo', duration: 'Corta (1–2 meses)', spaceRequired: 'Maceta pequeña (1–3 L)', plantType: 'Plantas aromáticas', difficulty: 1, daysToHarvest: 50, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Cosecha' }] },
    { id: 'albahaca', name: 'Albahaca', regionSlugs: ['andina', 'caribe', 'pacifica', 'orinoquia', 'amazonia', 'insular'], pancoger: false, patrimonial: true, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Hierba culinaria muy versátil, perfecta para huertos caseros.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'basil plant', estimatedPrice: 'Precio bajo', duration: 'Corta (1–2 meses)', spaceRequired: 'Maceta pequeña (1–3 L)', plantType: 'Plantas aromáticas', difficulty: 2, daysToHarvest: 70, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Cosecha' }] },
    { id: 'guayaba', name: 'Guayaba', regionSlugs: ['andina', 'caribe'], pancoger: true, patrimonial: true, sembrable_en_casa: 'parcialmente', educativo: 'sí', description: 'Árbol frutal fácil de cuidar que produce frutos deliciosos. Requiere macetón grande o suelo.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'guava tree', estimatedPrice: 'Precio bajo', duration: 'Larga (6 meses o más)', spaceRequired: 'Maceta grande o jardín (10+ L)', plantType: 'Frutales', difficulty: 3, daysToHarvest: 730, lifeCycle: [{ name: 'Semilla' }, { name: 'Plántula' }, { name: 'Producción' }] },
    { id: 'tomate_cherry', name: 'Tomate cherry', regionSlugs: ['andina', 'caribe', 'pacifica', 'orinoquia', 'amazonia', 'insular'], pancoger: false, patrimonial: false, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Pequeños tomates dulces y jugosos, ideales para cultivar en macetas.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'cherry tomatoes', estimatedPrice: 'Precio moderado', duration: 'Media (3–5 meses)', spaceRequired: 'Maceta grande o jardín (10+ L)', plantType: 'Hortalizas de fruto', difficulty: 2, daysToHarvest: 90, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Floración' }, { name: 'Cosecha' }] },
    { id: 'cebollin', name: 'Cebollín', regionSlugs: ['andina', 'caribe', 'pacifica', 'orinoquia', 'amazonia', 'insular'], pancoger: false, patrimonial: true, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Fácil de cultivar en macetas, añade un sabor suave a cebolla a tus platos.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'chives plant', estimatedPrice: 'Precio bajo', duration: 'Corta (1–2 meses)', spaceRequired: 'Maceta pequeña (1–3 L)', plantType: 'Hortalizas de hoja', difficulty: 1, daysToHarvest: 60, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Cosecha' }] },
    { id: 'maracuya', name: 'Maracuyá', regionSlugs: ['pacifica', 'andina', 'caribe'], pancoger: true, patrimonial: true, sembrable_en_casa: 'parcialmente', educativo: 'sí', description: 'Enredadera que produce una fruta tropical exótica y deliciosa.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'passion fruit vine', estimatedPrice: 'Precio moderado', duration: 'Larga (6 meses o más)', spaceRequired: 'Maceta grande o jardín (10+ L)', plantType: 'Frutales', difficulty: 4, daysToHarvest: 365, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Floración' }, { name: 'Cosecha' }] },
    { id: 'auyama', name: 'Auyama', regionSlugs: ['caribe', 'andina'], pancoger: true, patrimonial: true, sembrable_en_casa: 'sí', educativo: 'sí', description: 'Calabaza versátil y nutritiva, se puede cultivar en huertas o costales.', imageUrl: 'https://placehold.co/300x200.png', dataAiHint: 'squash plant', estimatedPrice: 'Precio bajo', duration: 'Media (3–5 meses)', spaceRequired: 'Maceta grande o jardín (10+ L)', plantType: 'Hortalizas de fruto', difficulty: 2, daysToHarvest: 100, lifeCycle: [{ name: 'Siembra' }, { name: 'Crecimiento' }, { name: 'Floración' }, { name: 'Cosecha' }] },
];
